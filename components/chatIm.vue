          ...
          <div class="content_list">
            ...
            <div class="chat_list" ref="Box"  @scroll="orderScroll">
              ...
              <template v-for="(item, index) in right_chat">
                ...
                <!-- 默认的发送的项目-顾客发送 -->
                  <div class="left_project new" v-if="(item.from == customer_id) &&  item.content.indexOf('{')!==-1">
                    <div class="head_image">
                ...
                <div
                  ...
                  v-if="(item.from == customer_id) &&  item.content.indexOf('data:image')==-1 && item.content.indexOf('{')==-1"
                  :key="index + 'right'"
                >
                  <div class="head_image">
          ...
          if(res.action==203){
              ...
              // this.websocketsend(JSON.stringify(data));
               ...
               //  返回业务员聊天
                ...
                if(sessionStorage.getItem(this.active_id)==1){  //在线
                      ...
                      this.people.map((p, q) => {
                        if (p.id == this.active_id) {
                                ...
                                if(res.data[res.data.length-1].content=="%put my card%"){
                                    ...
                                    msg="[我发送了一张图片]";
                                }else if(res.data[res.data.length-1].content.indexOf('{')!==-1){
                                    msg=`[客户浏览了${JSON.parse(res.data[res.data.length-1].content).name}]`;
                                }
                                else{
