<template>
  <div class="map">
    ...
    <nav class="top-nav">
        ...
        <div class="left">
            <div class="header1">
                <img src="~/assets/logo.png" class="top_logo" v-if="mine==0"/>
                <img src="~/assets/logo_yi.png" class="top_logo" v-if="mine==1"/>
            </div>
            <ul class="nav_li">
    ...
    <div class="sou_boxx">
      <h4>
        ...
        <em @click="clear_sel_tiao">
          <img src="~/assets/clear.png" alt class="kong" />
          <i class="m-go">清空条件</i>
        </em>
      </h4>
      <div class="sou_input_box">
        <div class="sou_input">
          <input type="text" placeholder="请输入楼盘名称、地域" autocomplete="off" class="img-text" v-model ="name_value" />
      ...
      <div class="select-list">
        ...
        <div class="huxing_list">
          <ul class="huxing_top">
            <li @click="getApartments(-2)">
              ...
              <!-- <input type="radio" value="不限" name="huxing" id="-2" /> -->
            </li>
            <li v-for="item in apartments" :key="item.id" @click="getApartments(item.id)">
              ...
              <!-- <input type="radio" :value="item.name" :id="item.id" name="huxing" /> -->
           </li>
          </ul>
          <div class="huxing_btn huxing_que">
            <span class="m-h-l" @click="clearHuXing">清空</span>
        ...
        <div class="shaixuan_list">
          ...
          <div class="huxing_btn shaixuan">
            <span class="m-h-l" @click="clearOthers">清空</span>
            <span class="m-h-r">确定</span>
          </div>
        </div>
        <!-- 排序列表 -->
     ...
     exitTip(){
      ...
      getNextLevel(level,id){
            ...
            //      _this._map.clearOverlays();
                  if (point.length > 0) {
                    this.point = point;
               //     console.log(this.point,this._map.getZoom());
                  ...
                  if (this.project_class == true && this.sample_class == false) {
                    ...
                    if (shang !== num.id) {
                      ...
                      //   console.log(num);
                          ...
                          target.parentNode.style.left =(num_left-142)+'px';
                          target.parentNode.style.top =(num_top-200)+'px';
                          target.parentNode.innerHTML = `<div class="pro_detail_dan" data-d="1">
                                <div class="pro_box" data-d="1">
                                    ...
                                    <div class="pro_right" data-d="1">
                                        <div class="pro_name" data-d="1"><em data-d="1">${item.name}</em> <span data-d="1">${item.status}</span></div>
                                        <div class="pro_jia" data-d="1">参考单价：<em data-d="1">约${item.price}</em>元/m²</div>
                                        <div class="pro_jian" data-d="1">建筑面积：<em data-d="1">${item.area}m²</em></div>
                                        <div class="pro_di"  data-d="1"><span data-d="1">楼盘地址：</span><em data-d="1">${item.address}</em></div>
                                        <div class="pro_tel" data-d="1"><span data-d="1">${item.phone}</span> <button class="saoma_btn" data-d="1" data-t="2"><em class="iconfont iconsaoma" data-d="1" data-t="2"></em>扫码拨号</button>
                                          <div class="ma_box">
                                              <h5>微信扫码拨号</h5>
                                              <img src="http://ll.edefang.net//index/weichat/code?channel=2" alt="">
                                          </div>
                                        </div>
                                        <div class="liao" data-d="1">致电售楼处了解更多信息</div>
                                    </div>
                                </div>
   ...
   // this.projectScroll();
    ...
    $(".click_qu").click(function() {
      ...
      if (flag == true) {
        $(this)
          .children()
          .attr("class", "iconfont iconshaixuan-shangjiantou");  //上
    ...
    $(".click_price").click(function() {
      ...
      if (flag1 == true) {
        $(this)
          .children()
          .attr("class", "iconfont iconshaixuan-shangjiantou"); //shang
...
@import "../../assets/css/map_new.less";
body,
html {
  width: 100%;
  height: 100%;
